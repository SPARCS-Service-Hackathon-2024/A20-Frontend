    ...
    var body: some View {
        NavigationStack {
            ScrollView(showsIndicators: false) {
                VStack {
                    ...
                    ZStack {
                        Rectangle()
                            ...
                            .background(Color(red: 0.97, green: 0.97, blue: 0.98))
                            .cornerRadius(8)
                        TextField("주소를 입력해주세요", text: $phoneNumber)
                          .font(Font.custom("PretendardVariable", size: 15))
                          .foregroundColor(Color(red: 0.51, green: 0.57, blue: 0.63))
                          .frame(width: 300)
                    }.padding(.bottom, 12)
                    ...
                    ZStack {
                        Rectangle()
                            ...
                            .background(Color(red: 0.97, green: 0.97, blue: 0.98))
                            .cornerRadius(8)
                        TextField("주차장 이름을 입력해주세요", text: $phoneNumber)
                          .font(Font.custom("PretendardVariable", size: 15))
                          .foregroundColor(Color(red: 0.51, green: 0.57, blue: 0.63))
                          .frame(width: 300)
                    }.padding(.bottom, 32)
                ...
                Button {
                    if !lenderName.isEmpty && !phoneNumber.isEmpty && !address.isEmpty && !parkingLotName.isEmpty && !relation.isEmpty {
...
//                        shareViewModel.relation = self.relation
                    ...
                    ZStack {
                        Rectangle()
                            .foregroundColor(.clear)
                            .frame(width: 331, height: 56)
                            .background(!lenderName.isEmpty && !phoneNumber.isEmpty && !address.isEmpty && !parkingLotName.isEmpty && !relation.isEmpty ? Color.mainColor : Color.lightGray)
                            .cornerRadius(8)
                        Text("다음")
                          .font(
                            Font.custom("PretendardVariable", size: 15)
